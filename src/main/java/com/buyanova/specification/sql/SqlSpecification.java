package com.buyanova.specification.sql;
 ...
 * @see com.buyanova.repository.user.implementation.SqlUserRepository#query(Specification)
 * @see com.buyanova.specification.sql.impl.user.FindUserByLoginAndPassword
 */
