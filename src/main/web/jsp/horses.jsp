...
<div class="container">
    <br/>
    <br/>
    <div class="nav-item dropdown md-form">
        <a class="nav-link dropdown-toggle" id="horsesDropdownMenuLink" data-toggle="dropdown"
           aria-haspopup="true" aria-expanded="false"><fmt:message bundle="${locale}"
                                                                   key="navbar.horses"/></a>
        <div class="dropdown-menu grey lighten-3"
             aria-labelledby="horsesDropdownMenuLink" style="width: 12rem;text-align: center">
            <form action="/controller" method="post">
                <input type="hidden" name="command" value="change_horses"/>
                <input type="hidden" name="jsp" value="${pageContext.request.requestURI}"/>
                <input style="width: 12rem" type="submit" name="horsesType" value="ALL"
                       class="dropdown-item font-weight-bold"/>
                <input style="width: 12rem" type="submit" name="horsesType" value="PERFORMING"
                       class="dropdown-item font-weight-bold"/>
                <input style="width: 12rem" type="submit" name="horsesType" value="NON-PERFORMING"
                       class="dropdown-item font-weight-bold"/>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="/controller" method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-elegant" name="command" value="edit_horse"><fmt:message
                                                    bundle="${locale}"
                                                    key="submit"/></button>
                                        </div>
                                    </form>
